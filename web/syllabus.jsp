	...
	<div class="container" style="background: #ffcd73">
      ...
      <div class="shortcodes"  style="background: #ffffff;">
		...
		<div class="page">
			...
			<h3 class="typo1" style="font-size: 37px;">Upload Syllabus</h3>
       ...
       <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <a href="smca.jsp"<button type="submit" class="btn btn-l btn-warning">MCA</button></a>
        </div>
      </div>
       ...
       <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <a href="smsc_cs.jsp"<button type="submit" class="btn btn-l btn-warning">M.Sc Computer Science</button></a>
        </div>
      </div>
       ...
       <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <a href="smsc_ae.jsp"<button type="submit" class="btn btn-l btn-warning">M.Sc Applied Electronics</button></a>
        </div>
      </div>
       ...
       <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <a href="smsc_ss.jsp"<button type="submit" class="btn btn-l btn-warning">M.Sc space science & technology</button></a>
        </div>
      </div>
